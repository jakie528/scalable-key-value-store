...
KVStoreService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_Die_(KVStoreService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status KVStoreService::Stub::Die(::grpc::ClientContext* context, const ::kvstore::DieRequest& request, ::kvstore::DieResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::kvstore::DieRequest, ::kvstore::DieResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_Die_, context, request, response);
}

void KVStoreService::Stub::async::Die(::grpc::ClientContext* context, const ::kvstore::DieRequest* request, ::kvstore::DieResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::kvstore::DieRequest, ::kvstore::DieResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_Die_, context, request, response, std::move(f));
}

void KVStoreService::Stub::async::Die(::grpc::ClientContext* context, const ::kvstore::DieRequest* request, ::kvstore::DieResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::kvstore::DieResponse>* KVStoreService::Stub::PrepareAsyncDieRaw(::grpc::ClientContext* context, const ::kvstore::DieRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::kvstore::DieResponse, ::kvstore::DieRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_Die_, context, request);
}

::grpc::ClientAsyncResponseReader< ::kvstore::DieResponse>* KVStoreService::Stub::AsyncDieRaw(::grpc::ClientContext* context, const ::kvstore::DieRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
KVStoreService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< KVStoreService::Service, ::kvstore::DieRequest, ::kvstore::DieResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](KVStoreService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::kvstore::DieRequest* req,
             ::kvstore::DieResponse* resp) {
...
::grpc::Status KVStoreService::Service::Die(::grpc::ServerContext* context, const ::kvstore::DieRequest* request, ::kvstore::DieResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
